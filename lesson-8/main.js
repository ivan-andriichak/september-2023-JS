...
//
// newBlock.textContent = 'Block';
//
// newBlock.style.backgroundColor = 'silver';
// newBlock.style.width = '25%';
// newBlock.style.color = 'darkgreen';
// newBlock.style.fontSize = '2 rem';
//
// document.body.appendChild(newBlock);
// const brBlock = document.createElement("br");
// document.body.appendChild(brBlock);
//
//
// const cloneNewBlock = newBlock.cloneNode(true);
// cloneNewBlock.textContent = 'New block';
//
// document.body.appendChild(cloneNewBlock);
...
//     blockElement.innerHTML =  `<strong>Title:</strong> ${item.title}<br><strong>Duration:</strong> ${item.monthDuration} months`;
...
//     paragraph.innerText = `${item.monthDuration} months`;
//
...
//     <p>Вік: ${simpson.age}</p>
//     <img src="${simpson.photo}" alt="Фотографія ${simpson.name}">
//     <p>${simpson.info}</p>
//   `;
//
